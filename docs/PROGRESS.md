...
- Toast/flash notifications now auto-dismiss after 5 s via a `FlashAutoHide` JS hook on the shared `flash/1` component (fixes [#39](https://github.com/rizafahmi/donatex/issues/39)); connection-error toasts stay manual; see [Milestone 12 log](file:///Users/riza/code/donatex/docs/milestones/12-toast-auto-hide/milestone-log.md)
...
- [x] [#39](https://github.com/rizafahmi/donatex/issues/39) Toast auto-hide — shared `flash/1` component now auto-dismisses after 5 s via a `FlashAutoHide` JS hook; connection-error toasts opt out; see [milestone-log](file:///Users/riza/code/donatex/docs/milestones/12-toast-auto-hide/milestone-log.md).
