...
### `lib/notable_web/live/donate_live.ex`
...
- New `test/notable_web/live/donate_live_tip_rate_limit_test.exs` — second tip from same IP within 10s does not call Mayar again.
