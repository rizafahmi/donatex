defmodule DonatexWeb.Router do
  use DonatexWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug DonatexWeb.Plugs.VisitorId
    plug :fetch_live_flash
    plug :put_root_layout, html: {DonatexWeb.Layouts, :root}
    plug :protect_from_forgery
    plug :put_secure_browser_headers, DonatexWeb.SecurityHeaders.headers()
    plug DonatexWeb.Plugs.SEO
  end
  ...
  # scope "/api", DonatexWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:donatex, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DonatexWeb.Telemetry
